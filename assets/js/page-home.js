$(document).ready(function () {
	...
	$(".animated-text-effect").typed({
		...
		strings: ["Welcome to Unik Creative Zone!", "We specialize in blending creativity and cutting-edge technology to craft software solutions that are highly efficient while maintaining a user-friendly essence.", "We engage in branding, designing, and development endeavors.",  "We are the partner you need to help your business succeed and make a difference in the world"], 
		contentType: "text", 
		typeSpeed: 30, 
		loop: true, 
		backDelay: 1200, 
